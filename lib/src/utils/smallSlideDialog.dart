...
class SmallSlideDialog extends StatefulWidget {
  final Widget child;
  ...
  @override
  _SmallSlideDialogState createState() => _SmallSlideDialogState();
}

class _SmallSlideDialogState extends State<SmallSlideDialog> {
